...
//-------------------------------------------------------------------------------------------------
// Name:  SnowParticle::InitSnowParticle( )
// Desc: 粒子系统初始化函数
//-------------------------------------------------------------------------------------------------
HRESULT SnowParticle::InitSnowParticle()
{
	...
	//创建6种雪花纹理
	D3DXCreateTextureFromFile(m_pd3dDevice, _T("GameMedia\\snow1.jpg"), &m_pTexture[0]);
	D3DXCreateTextureFromFile(m_pd3dDevice, _T("GameMedia\\snow2.jpg"), &m_pTexture[1]);
	D3DXCreateTextureFromFile(m_pd3dDevice, _T("GameMedia\\snow3.jpg"), &m_pTexture[2]);
	D3DXCreateTextureFromFile(m_pd3dDevice, _T("GameMedia\\snow4.jpg"), &m_pTexture[3]);
	D3DXCreateTextureFromFile(m_pd3dDevice, _T("GameMedia\\snow5.jpg"), &m_pTexture[4]);
	D3DXCreateTextureFromFile(m_pd3dDevice, _T("GameMedia\\snow6.jpg"), &m_pTexture[5]);
...
//-------------------------------------------------------------------------------------------------
// Name:  SnowParticle::UpdateSnowParticle( )
// Desc: 粒子系统更新函数
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
// Name:  SnowParticle::RenderSnowParticle( )
// Desc: 粒子系统渲染函数
//-------------------------------------------------------------------------------------------------
